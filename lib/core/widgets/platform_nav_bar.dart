          ...
          child: Row(
            ...
            children: [
              if (!isSeller) ...[
                ...
                _buildNavItem(context, 1, Icons.attach_money, "Earnings", currentIndex),
                _buildNavItem(context, 2, Icons.calendar_month_outlined, "Upcoming", currentIndex),
                _buildNavItem(
                  context,
                  3,
                  Icons.chat_bubble_outline,
                ...
                _buildNavItem(context, 4, Icons.person_outline, "Profile", currentIndex),
              ],
            ],
          ),
        );
